            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <section class="categorias">
                        <!-- Incluir la vista parcial de las categorías -->
...
<!-- Modal Agregar -->
<div class="modal fade" id="ModalCategoria" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static"
...
<script>
    ...
    $(function () {
        ...
        window.limpiarModalCategoria = function () {
            // Limpiar el formulario modal de categoría
        ...
        // Función para cargar las categorías mediante AJAX
        ...
        $("#formCategoria").submit(function (e) {
            ...
            // Valida si el campo categoria_id está vacío
            if (hddcategoria_id != "") {
        ...
        // Ajax para registrar una nueva categoría
                ...
                success: function (response) {
                    ...
                    // Manejo de errores de validación
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'ERROR...',
                            html: '<ul>' + categoriavalidation + '</ul>'
                        });
                    }
        ...
        window.mostrarCategoria = function (categoria_id) {
        ...
        window.eliminarCategoria = function (categoria_id) {
            Swal.fire({
                icon: 'warning',
        ...
        window.desactivarCategoria = function (categoria_id) {
            Swal.fire({
                icon: 'warning',
